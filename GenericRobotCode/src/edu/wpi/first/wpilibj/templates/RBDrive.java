 ...
 * @author Sawyer
 */
public class RBDrive implements MotorSafety, IUtility {
...
* @param leftMotorChannel The PWM channel number on the default digital
     ...
     */
    public RBDrive(final int leftMotorChannel, final int rightMotorChannel) {
...
* @param frontLeftMotor Front left motor channel number on the default
     ...
     * digital module
     */
    public RBDrive(final int frontLeftMotor, final int rearLeftMotor,
        ...
        //this.setInvertedMotor(MotorType.kRearLeft, true); //derp
...
* @param leftMotor The left SpeedController object used to drive the robot.
     ...
     * robot.
     */
    public RBDrive(SpeedController leftMotor, SpeedController rightMotor) {
...
* @param rearLeftMotor The back left SpeedController object used to drive
     ...
     * drive the robot.
     */
    public RBDrive(SpeedController frontLeftMotor, SpeedController rearLeftMotor,
...
* @param x The speed that the robot should drive in the X direction.
    ...
    public void mecanumDrive_Cartesian(double x, double y, double rotation, double gyroAngle) {
        ...
        //System.out.println("v2 Rotation: " + rotation);
        ...
        //Prints out motor voltage outputs
        System.out.print("FL " + wheelSpeeds[MotorType.kFrontLeft_val] * m_invertedMotors[MotorType.kFrontLeft_val] * m_maxOutput);
        System.out.print(" FR " + wheelSpeeds[MotorType.kFrontRight_val] * m_invertedMotors[MotorType.kFrontRight_val] * m_maxOutput);
        System.out.print(" || RL " + wheelSpeeds[MotorType.kRearLeft_val] * m_invertedMotors[MotorType.kRearLeft_val] * m_maxOutput);
        System.out.println(" RR " + wheelSpeeds[MotorType.kRearRight_val] * m_invertedMotors[MotorType.kRearRight_val] * m_maxOutput);
...
* @param magnitude The speed that the robot should drive in a given
    ...
    public void mecanumDrive_Polar(double magnitude, double direction, double rotation) {
        ...
        System.out.print(wheelSpeeds[MotorType.kFrontLeft_val] * m_invertedMotors[MotorType.kFrontLeft_val] * m_maxOutput);
        System.out.print(" " + wheelSpeeds[MotorType.kRearLeft_val] * m_invertedMotors[MotorType.kRearLeft_val] * m_maxOutput);
        System.out.print(" || " + wheelSpeeds[MotorType.kFrontRight_val] * m_invertedMotors[MotorType.kFrontRight_val] * m_maxOutput);
        System.out.println(" " + wheelSpeeds[MotorType.kRearRight_val] * m_invertedMotors[MotorType.kRearRight_val] * m_maxOutput);
...
* @param maxOutput Multiplied with the output percentage computed by the
    ...
    /**
     * Free the speed controllers if they were allocated locally protected void
     * free() { if (m_allocatedSpeedControllers) { if (m_frontLeftMotor != null)
     * { ((PWM) m_frontLeftMotor).free(); } if (m_frontRightMotor != null) {
     * ((PWM) m_frontRightMotor).free(); } if (m_rearLeftMotor != null) { ((PWM)
     * m_rearLeftMotor).free(); } if (m_rearRightMotor != null) { ((PWM)
     * m_rearRightMotor).free(); } } }
     */
